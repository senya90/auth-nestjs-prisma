/*
  ...
  - You are about to drop the column `prodiver` on the `accounts` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "accounts_prodiver_provider_id_key";

-- AlterTable
ALTER TABLE "accounts" DROP COLUMN "prodiver",
